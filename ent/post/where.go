...
func Likes(v uint32) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func LikesEQ(v uint32) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLikes), v))
	})
}
...
func LikesNEQ(v uint32) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func LikesIn(vs ...uint32) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LikesNotIn(vs ...uint32) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LikesGT(v uint32) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func LikesGTE(v uint32) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func LikesLT(v uint32) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func LikesLTE(v uint32) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
